...
export default function OrganizerPage(){
 ...
 return <main><Nav/><div className="mx-auto max-w-7xl px-6 py-12 sm:py-16"><div className="flex flex-wrap items-end justify-between gap-6"><div><p className="eyebrow text-accent">ORGANIZER COMMAND CENTER</p><h1 className="mt-2 text-5xl font-black tracking-[-.055em] sm:text-6xl">Run every event<br/>from one place.</h1><p className="mt-4 max-w-2xl text-base font-medium leading-7 text-ink/55">Create, distribute, manage, verify and measure your onchain attendance without leaving the protocol workflow.</p></div><Link href="/register" className="btn-primary">+ Create event</Link></div>
 ...
 <div className="mt-5"><OrganizerReputation creator={address} events={mine.length} attendees={totalClaims}/></div>
